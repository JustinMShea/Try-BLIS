...
BLIS/libFLAME places $1st$ of 7 with a time of $`r round(BLIS_fun_elapsed,2)`$ seconds, beats the next submission by a factor of 5, and the last by a factor of 18.
...
- **Brett Klamer:** Windows setup [http://brettklamer.com/diversions/statistical/faster-blas-in-r/](http://brettklamer.com/diversions/statistical/faster-blas-in-r/)
